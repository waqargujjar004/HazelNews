...
class NewsStateHandler {
    ...
    private fun updatePagination(totalResults: Int, binding: FragmentHeadlinesBinding?, viewModel: NewsViewModel) {
...
//
//        setupRecyclerView()
//        newsViewModel.onEvent(NewsEvent.FetchHeadlines("us")) // Load initial data
//
...
//@AndroidEntryPoint
//
//class HeadlinesFragment : BaseFragment(R.layout.fragment_headlines) {
//
...
//    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
//        super.onViewCreated(view, savedInstanceState)
//        binding = FragmentHeadlinesBinding.bind(view) // ✅ Initialize binding
//
